...
nsamples_array = [300]  # resolution in time
tfinal = 5e-6  # seconds
...
plt.ylabel(r"$r$")
plt.subplot(3, 3, 2)
plt.plot(g_orbit_vmec.time, g_orbit_vmec.theta_pos, label="vmec")
...
plt.plot(g_orbit_booz.time, g_orbit_booz.varphi_pos, label="vmec")
plt.legend()
plt.xlabel(r"$t (s)$")
plt.ylabel(r"$\varphi$")
plt.subplot(3, 3, 4)
...
plt.plot(g_orbit_vmec.time, g_orbit_vmec.thetadot, 'r-', label=r"$\dot \theta$ vmec")
plt.plot(
    g_orbit_booz.time, g_orbit_booz.thetadot, 'b--', label=r"$\dot \theta$ booz"
)
plt.plot(g_orbit_vmec.time, g_orbit_vmec.varphidot, 'r-', label=r"$\dot \varphi$ vmec")
plt.plot(
    g_orbit_booz.time,
    g_orbit_booz.varphidot, 'b--',
    label=r"$\dot \varphi$ booz",
)
plt.xlabel(r"$t (s)$")
plt.legend()
plt.subplot(3, 3, 8)
plt.plot(
    g_orbit_vmec.r_pos * np.cos(g_orbit_vmec.theta_pos),
    g_orbit_vmec.r_pos * np.sin(g_orbit_vmec.theta_pos),
    label="vmec",
)
plt.plot(
...
plt.plot(
    g_orbit_booz.time, g_orbit_booz.magnetic_field_strength, label="booz"
)
plt.legend()
plt.xlabel(r"$t$")
plt.ylabel(r"$|B|$")
