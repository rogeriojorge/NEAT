...
def get_stel(nphi,ind):
    if ind==0:
        ...
        I2     = 2
        B0     = 3
        stel   = Qsc(rc=eR,zs=eZ,etabar=eta,nfp=2,nphi=nphi,I2=I2,order='r2',B0=B0,B2c=B2c)
    ...
    if ind==4:
        ...
        Lambda = [0.2]
    if ind==5:
        stel=Qsc(rc=[1, 0.17, 0.01804, 0.001409, 5.877e-05], zs=[0, 0.1581, 0.01820, 0.001548, 7.772e-05], nfp=4, etabar=1.569, order='r2', B2c=-2.5 , B0=2)
