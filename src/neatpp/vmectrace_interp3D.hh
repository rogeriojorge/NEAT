...
class push_back_state_and_time_vmec_interp3D {
public:
  vector< vector< double > >& m_states;
  push_back_state_and_time_vmec_interp3D(vector< vector< double > > &states,
        ...
        size_t nsamples, double Tfinal)
{
  ...
  push_back_state_and_time_vmec_interp3D observer(x_vec, &veq, &gc);
