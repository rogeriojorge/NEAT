...
#ifndef GYRONIMO_EQUILIBRIUM_VMEC_OPTIMIZED
#define GYRONIMO_EQUILIBRIUM_VMEC_OPTIMIZED
...
/*!
    ...
    The coordinates are set by the `metric_vmec_optimize` object and the type of 1d
...
//   virtual IR3 del_magnitude(const IR3& position, double time) const override;
  ...
  const metric_vmec_optimized* metric() const {return metric_;};
 private:
  const metric_vmec_optimized *metric_;
...
#endif // GYRONIMO_EQUILIBRIUM_VMEC_OPTIMIZED
